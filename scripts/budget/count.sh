...
LOCAL=(11 11 11 11 11 11 11 11 11 11 11)
GLOBAL=(36 36 36 36 36 36 36 36 36 36 36)
COUNT=(40 80 160 341 650 1295 2592)
...
if [[ -f "$PRED_FILE" ]]; then
    for i in {0..6}; do
        ...
        echo "Running: $BASE_COMMAND $TRACE > results/budget/count/$OUTPUT_FILE"
        $BASE_COMMAND $TRACE > "results/budget/count/$OUTPUT_FILE"
    done
else
