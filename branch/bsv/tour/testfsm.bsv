...
module mkTestbench(Empty);
    DirPredictor#(TourTrainInfo) myPredictor <- mkTourPred();
    ...
    function Action update(Tuple2#(TourTrainInfo, Bool) b, Bool truthTaken) = action
      TourTrainInfo trainInfo = tpl_1(b);
