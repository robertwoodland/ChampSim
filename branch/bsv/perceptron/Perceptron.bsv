...
typedef 19 PerceptronGHistEntries; // Numeric: Size of global history
...
typedef 1450 PerceptronCount; // Numeric: Number of perceptrons - depends on hash function. Made smaller as would take ages to initialise...
